[README.md](https://github.com/user-attachments/files/31638366/README.md)
# EBookReader
...
- 选中文字（复制 / 分享 / 划线 / 批注）仅在 **上下滚动模式** 下可用，左右翻页模式不支持长按选择。
