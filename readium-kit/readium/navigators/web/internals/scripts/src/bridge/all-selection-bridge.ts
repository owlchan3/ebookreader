...
export class ReflowableSelectionBridge {
  ...
  selectAtPoint(x: number, y: number): Selection | null {
    return this.manager.selectAtPoint(x, y)
  }

  getStartHandleRect(): Rect | null {
    return this.manager.getStartHandleRect()
  }

  getEndHandleRect(): Rect | null {
    return this.manager.getEndHandleRect()
  }

  extendStart(x: number, y: number): Selection | null {
    return this.manager.extendStart(x, y)
  }

  extendEnd(x: number, y: number): Selection | null {
    return this.manager.extendEnd(x, y)
  }
}
