    ...
    private fun injectStyles(content: StringBuilder) {
        ...
        content.insert(
            ...
            "\n" + buildList {
                ...
                // Allow user text selection across all content, except when selection is
                // disabled (e.g. paged mode) where we enforce user-select:none instead.
                val userSelectRule = if (disableSelection) {
